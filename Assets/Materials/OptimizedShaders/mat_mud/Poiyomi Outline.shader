Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/c6f330f893500da469ae25cbc6630ca9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4811321,0.3134895,0.1747508,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.4811321,0.3134895,0.1747508,1).a;
				...
				{
					float shift = (0.01 /*_MainHueShift*/);
					#ifdef POI_AUDIOLINK
