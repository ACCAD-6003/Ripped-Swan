Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/0a7c00092409d894490276c46e7e4cd8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateRGBMask(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_REDTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 red = POI2D_SAMPLER_PAN_STOCHASTIC(_RedTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RedTextureUV*/)], float4(1,1,0,0)), float4(0,11,0,0), (1.0 /*_RedTextureStochastic*/));
				#else
				float4 red = 1;
				#endif
				#if defined(PROP_GREENTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				float4 maskFinal = 1;
				maskFinal.r = red.a   * saturate((rgbMask[(0.0 /*_RgbRedMaskChannel*/)  ] * float4(1,1,1,1).a  ) + (-0.482 /*_RedAlphaAdd*/)  );
				...
				if ((0.0 /*_RgbRedGlobalMaskChannel*/)   > 0) maskFinal.r = customBlend(maskFinal.r, poiMods.globalMask[(0.0 /*_RgbRedGlobalMaskChannel*/)-1],   (0.0 /*_RgbRedGlobalMaskBlendType*/)  );
				...
				if ((0.0 /*_RGBBlendMultiplicative*/))
				{
					float3 RGBColor = 1;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					mainUV = sharpSample(float4(0.001182033,0.001182033,846,846), mainUV);
				}
