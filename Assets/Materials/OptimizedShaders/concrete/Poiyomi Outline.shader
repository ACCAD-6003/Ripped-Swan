Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/542fff684e4030f43bf29d8ab3052ccc"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.490566,0.4597873,0.4373442,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.490566,0.4597873,0.4373442,1).a;
				...
				{
					float shift = (0.032 /*_MainHueShift*/);
					#ifdef POI_AUDIOLINK
